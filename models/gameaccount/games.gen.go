...
func newGame(db *gorm.DB, opts ...gen.DOOption) game {
	...
	_game.Type = field.NewString(tableName, "type")
	_game.RoomID = field.NewString(tableName, "room_id")
	_game.Status = field.NewInt32(tableName, "status")
	_game.MaxPlayers = field.NewInt32(tableName, "max_players")
	_game.CurrentPlayers = field.NewInt32(tableName, "current_players")
	_game.CreatedAt = field.NewTime(tableName, "created_at")
	_game.StartedAt = field.NewTime(tableName, "started_at")
	_game.EndedAt = field.NewTime(tableName, "ended_at")
...
func (g *game) updateTableName(table string) *game {
	...
	g.RoomID = field.NewString(table, "room_id")
	...
	g.EndedAt = field.NewTime(table, "ended_at")
