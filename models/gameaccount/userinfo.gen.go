...
func newUserinfo(db *gorm.DB, opts ...gen.DOOption) userinfo {
	...
	_userinfo.UserID = field.NewInt32(tableName, "userId")
	_userinfo.Devid = field.NewInt32(tableName, "Devid")
	_userinfo.Firstexchange = field.NewBool(tableName, "firstexchange")
	_userinfo.Zhifubao = field.NewString(tableName, "zhifubao")
	_userinfo.ZhifubaoName = field.NewString(tableName, "zhifubaoName")
...
type userinfo struct {
	...
	UserID        field.Int32
	Devid         field.Int32
	Firstexchange field.Bool
	Zhifubao      field.String
	ZhifubaoName  field.String
...
func (u *userinfo) updateTableName(table string) *userinfo {
	...
	u.Devid = field.NewInt32(table, "Devid")
	u.Firstexchange = field.NewBool(table, "firstexchange")
	u.Zhifubao = field.NewString(table, "zhifubao")
	u.ZhifubaoName = field.NewString(table, "zhifubaoName")
...
func (u *userinfo) fillFieldMap() {
	...
	u.fieldMap["Devid"] = u.Devid
	u.fieldMap["firstexchange"] = u.Firstexchange
	u.fieldMap["zhifubao"] = u.Zhifubao
	u.fieldMap["zhifubaoName"] = u.ZhifubaoName
}
