...
func newTUser(db *gorm.DB, opts ...gen.DOOption) tUser {
	...
	_tUser.Coins = field.NewFloat64(tableName, "coins")
	_tUser.Gems = field.NewFloat64(tableName, "gems")
	_tUser.Roomid = field.NewString(tableName, "roomid")
	_tUser.History = field.NewString(tableName, "history")
	_tUser.Yaoqing = field.NewInt32(tableName, "yaoqing")
	_tUser.Time = field.NewInt32(tableName, "time")
	_tUser.Shareroomid = field.NewString(tableName, "shareroomid")
	_tUser.Robot = field.NewInt32(tableName, "robot")
...
type tUser struct {
	...
	Lv          field.Int32   // 用户等级
	Exp         field.Int32   // 用户经验
	Coins       field.Float64 // 用户金币
	Gems        field.Float64 // 用户宝石
	Roomid      field.String  // 所在房间号
	History     field.String  // 历史
	Yaoqing     field.Int32   // 邀请人
	Time        field.Int32   // 注册时间
	Shareroomid field.String
	Robot       field.Int32
...
func (t *tUser) updateTableName(table string) *tUser {
	...
	t.Coins = field.NewFloat64(table, "coins")
	t.Gems = field.NewFloat64(table, "gems")
	t.Roomid = field.NewString(table, "roomid")
	t.History = field.NewString(table, "history")
	t.Yaoqing = field.NewInt32(table, "yaoqing")
	t.Time = field.NewInt32(table, "time")
	t.Shareroomid = field.NewString(table, "shareroomid")
	t.Robot = field.NewInt32(table, "robot")
...
func (t *tUser) fillFieldMap() {
	...
	t.fieldMap["yaoqing"] = t.Yaoqing
	t.fieldMap["time"] = t.Time
	t.fieldMap["shareroomid"] = t.Shareroomid
	t.fieldMap["robot"] = t.Robot
}
