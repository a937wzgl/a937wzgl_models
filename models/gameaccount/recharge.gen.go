...
func newRecharge(db *gorm.DB, opts ...gen.DOOption) recharge {
	...
	_recharge.UserID = field.NewInt32(tableName, "userId")
	_recharge.Account = field.NewString(tableName, "Account")
	_recharge.TotalFee = field.NewUint32(tableName, "total_fee")
	_recharge.OutTradeNo = field.NewString(tableName, "out_trade_no")
	_recharge.Goodsid = field.NewInt32(tableName, "goodsid")
	_recharge.State = field.NewBool(tableName, "state")
	_recharge.CreateTime = field.NewTime(tableName, "createTime")
...
type recharge struct {
	...
	TotalFee   field.Uint32
	OutTradeNo field.String
	Goodsid    field.Int32
	State      field.Bool // 1是充值成功；0是未充值只点进来过；
...
func (r *recharge) updateTableName(table string) *recharge {
	...
	r.TotalFee = field.NewUint32(table, "total_fee")
	r.OutTradeNo = field.NewString(table, "out_trade_no")
	r.Goodsid = field.NewInt32(table, "goodsid")
	r.State = field.NewBool(table, "state")
...
func (r *recharge) fillFieldMap() {
	...
	r.fieldMap["out_trade_no"] = r.OutTradeNo
	r.fieldMap["goodsid"] = r.Goodsid
