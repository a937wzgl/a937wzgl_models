...
func newTAccount(db *gorm.DB, opts ...gen.DOOption) tAccount {
	...
	_tAccount.Account = field.NewString(tableName, "account")
	_tAccount.Password = field.NewString(tableName, "password")
	_tAccount.RegTime = field.NewInt32(tableName, "reg_time")
