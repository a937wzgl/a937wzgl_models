...
func newTUser(db *gorm.DB, opts ...gen.DOOption) tUser {
	...
	_tUser.Userid = field.NewUint32(tableName, "userid")
	_tUser.Account = field.NewString(tableName, "account")
	_tUser.Name = field.NewString(tableName, "name")
	_tUser.Sex = field.NewInt32(tableName, "sex")
	_tUser.Headimg = field.NewString(tableName, "headimg")
	_tUser.Lv = field.NewInt32(tableName, "lv")
	_tUser.Exp = field.NewInt32(tableName, "exp")
	_tUser.Coins = field.NewInt32(tableName, "coins")
	_tUser.Vip = field.NewInt32(tableName, "vip")
	_tUser.Money = field.NewInt32(tableName, "money")
	_tUser.Gems = field.NewInt32(tableName, "gems")
	_tUser.Roomid = field.NewString(tableName, "roomid")
	_tUser.History = field.NewString(tableName, "history")
	_tUser.Power = field.NewInt32(tableName, "power")
	_tUser.RenameCount = field.NewInt32(tableName, "RenameCount")
	_tUser.ReHeadCount = field.NewInt32(tableName, "ReHeadCount")
	_tUser.PropID = field.NewInt32(tableName, "propId")
...
type tUser struct {
	...
	ALL         field.Asterisk
	Userid      field.Uint32 // 鐢ㄦ埛ID
	Account     field.String // 璐﹀彿
	Name        field.String // 鐢ㄦ埛鏄电О
	Sex         field.Int32
	Headimg     field.String
	Lv          field.Int32 // 鐢ㄦ埛绛夌骇
	Exp         field.Int32 // 鐢ㄦ埛缁忛獙
	Coins       field.Int32 // 鐢ㄦ埛閲戝竵
	Vip         field.Int32
	Money       field.Int32
	Gems        field.Int32 // 鐢ㄦ埛瀹濈煶
	Roomid      field.String
	History     field.String
	Power       field.Int32
	RenameCount field.Int32
	ReHeadCount field.Int32
	PropID      field.Int32
...
func (t *tUser) updateTableName(table string) *tUser {
	...
	t.Headimg = field.NewString(table, "headimg")
	t.Lv = field.NewInt32(table, "lv")
	t.Exp = field.NewInt32(table, "exp")
	t.Coins = field.NewInt32(table, "coins")
	t.Vip = field.NewInt32(table, "vip")
	t.Money = field.NewInt32(table, "money")
	t.Gems = field.NewInt32(table, "gems")
	t.Roomid = field.NewString(table, "roomid")
	t.History = field.NewString(table, "history")
	t.Power = field.NewInt32(table, "power")
	t.RenameCount = field.NewInt32(table, "RenameCount")
	t.ReHeadCount = field.NewInt32(table, "ReHeadCount")
...
func (t *tUser) fillFieldMap() {
	...
	t.fieldMap["headimg"] = t.Headimg
	t.fieldMap["lv"] = t.Lv
	t.fieldMap["exp"] = t.Exp
	t.fieldMap["coins"] = t.Coins
	t.fieldMap["vip"] = t.Vip
	t.fieldMap["money"] = t.Money
	t.fieldMap["gems"] = t.Gems
	t.fieldMap["roomid"] = t.Roomid
	t.fieldMap["history"] = t.History
	t.fieldMap["power"] = t.Power
	t.fieldMap["RenameCount"] = t.RenameCount
	t.fieldMap["ReHeadCount"] = t.ReHeadCount
