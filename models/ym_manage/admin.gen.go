...
func newAdmin(db *gorm.DB, opts ...gen.DOOption) admin {
	...
	_admin.ID = field.NewUint32(tableName, "id")
	...
	_admin.Isagent = field.NewBool(tableName, "isagent")
...
func (a *admin) updateTableName(table string) *admin {
	...
	a.Isagent = field.NewBool(table, "isagent")
