...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.HeadImgURL = field.NewString(tableName, "head_img_url")
	_user.Score = field.NewInt64(tableName, "score")
	_user.Diamond = field.NewInt64(tableName, "diamond")
	_user.Status = field.NewInt32(tableName, "status")
	_user.IsOfficial = field.NewBool(tableName, "is_official")
...
func (u *user) updateTableName(table string) *user {
	...
	u.HeadImgURL = field.NewString(table, "head_img_url")
	u.Score = field.NewInt64(table, "score")
	u.Diamond = field.NewInt64(table, "diamond")
	u.Status = field.NewInt32(table, "status")
	u.IsOfficial = field.NewBool(table, "is_official")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["head_img_url"] = u.HeadImgURL
	u.fieldMap["score"] = u.Score
	u.fieldMap["diamond"] = u.Diamond
	u.fieldMap["status"] = u.Status
	u.fieldMap["is_official"] = u.IsOfficial
