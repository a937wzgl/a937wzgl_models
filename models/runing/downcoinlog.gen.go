...
func newDowncoinlog(db *gorm.DB, opts ...gen.DOOption) downcoinlog {
	...
	_downcoinlog.DownCoin = field.NewInt32(tableName, "downCoin")
	_downcoinlog.WinCoin = field.NewInt32(tableName, "winCoin")
	_downcoinlog.Open2 = field.NewInt32(tableName, "open2")
	_downcoinlog.Open3 = field.NewInt32(tableName, "open3")
	_downcoinlog.Open4 = field.NewInt32(tableName, "open4")
...
func (d *downcoinlog) updateTableName(table string) *downcoinlog {
	...
	d.DownCoin = field.NewInt32(table, "downCoin")
	d.WinCoin = field.NewInt32(table, "winCoin")
	d.Open2 = field.NewInt32(table, "open2")
	d.Open3 = field.NewInt32(table, "open3")
	d.Open4 = field.NewInt32(table, "open4")
...
func (d *downcoinlog) fillFieldMap() {
	...
	d.fieldMap["downCoin"] = d.DownCoin
	d.fieldMap["winCoin"] = d.WinCoin
	d.fieldMap["open2"] = d.Open2
	d.fieldMap["open3"] = d.Open3
	d.fieldMap["open4"] = d.Open4
