...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.Flag = field.NewString(tableName, "flag")
	_config.Value = field.NewString(tableName, "value")
	_config.Type = field.NewBool(tableName, "type")
	_config.Award = field.NewUint32(tableName, "award")
...
func (c *config) updateTableName(table string) *config {
	...
	c.Award = field.NewUint32(table, "award")
